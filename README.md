...
tests/              76 tests: unit, integration, detection quality, and plan-shape gates
```
...
76 tests across four tiers, plus 78 dbt tests inside the build. mypy runs in strict mode, and
